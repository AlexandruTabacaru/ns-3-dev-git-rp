...
TypeId TcpPrague::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TcpPrague")
    ...
    .AddAttribute ("RttScalingMode", "RTT Independence Scaling Heuristic",
                   ...
                   MakeEnumAccessor<RttScalingMode_t> (&TcpPrague::GetRttScalingMode, 
                                                      &TcpPrague::SetRttScalingMode),
...
TcpPrague::RttScalingMode_t
TcpPrague::GetRttScalingMode (void) const
{
  return m_rttScalingMode;
}
