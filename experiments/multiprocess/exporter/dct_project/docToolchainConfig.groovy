...
// referenceDocFile = "${inputPath}/Template-2022_Specification.docx"
...
inputFiles = [
	[file: 'template/experiment-results.adoc', formats: ['html','pdf', 'docbook', 'docx']],
	/** inputFiles **/
]
...
microsite.with {
    ...
    // Example: https://github.com/doctoolchain/doctoolchain/edit/master/docs
...
confluence.with {
    input = [
            [ file: "build/html5/template-template-de.html" ],
    ]

    // endpoint of the confluenceAPI (REST) to be used
    // if you use Confluence Cloud, you can set this value to
    // https://[yourServer]
    // a working example is https://template-template.atlassian.net
    // if you use Confluence Server, you may need to set a context:
    // https://[yourServer]/[context]
    // a working example is https://template-template.atlassian.net/wiki
...
openApi.with {
    specFile = 'docs/apis/api-openapi.yaml'
    infoUrl = 'https://cablelabs.com'
...
structurizr.with {
    ...
    export = {
        ...
        // outputPath = 'docs/structurizr/diagrams'
